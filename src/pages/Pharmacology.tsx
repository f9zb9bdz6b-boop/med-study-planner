        ...
        >
          ...
          >
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-4">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {showAIModal.action === 'explain' && 
                  'AI will provide a detailed explanation of this topic with key concepts and clinical correlations.'}
                {showAIModal.action === 'mcqs' && 
                  'AI will generate practice MCQs based on this topic to test your understanding.'}
                {showAIModal.action === 'revision' && 
                  'AI will create a quick revision summary with high-yield points and mnemonics.'}
              </p>
            </div>
            <div className="flex gap-3">
              ...
              <button
                onClick={() => {
                  // AI action would be implemented here
